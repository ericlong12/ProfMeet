...
public class OfficeHoursPage {
    ...
    public void show() {
        ...
        fromHour.setPromptText("HH:MM");
        TimePicker toHour = new TimePicker();
        toHour.setpromptText("HH:MM");
        ...
        submit.setOnAction(e -> {
            ...
            if (fromHour.getText().isEmpty() || toHour.getText().isEmpty()) {
                error.add("Please select a valid time slot!");
            }

            if (courseCode.getText().isEmpty()){
                error.add("Please enter a valid Course Code!");
            }

            if (courseName.getText().isEmpty()){
                error.add("Course Name is required!");
            }

            if (courseSection.getText().isEmpty()){
                error.add("Course Section is required!");
            }
